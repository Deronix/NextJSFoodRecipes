...
export default function Footer({ locale }) {
  ...
  // Footer links with locale support
  const footerLinks = {
    about: [
      ...
      <div className="container-default py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link href={`/${locale}`}>
              <h2 className="text-2xl font-bold text-red-500">Global Food Hub</h2>
            </Link>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Discover recipes, articles, and cooking education from around the world.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              {footerLinks.about.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-gray-600 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
            &copy; {currentYear} Global Food Hub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
